...
data = JLD2.load("../data/cubic_ikeda.jld2");
eq = data["equation"];
...
phase_shift = coefficients(component(return_periodic_orbit, m)(1, 0));
...
@show τ;
@show phase_shift = coefficients(component(return_periodic_orbit, m)(1, 0));
@show σ;
@show return_window;
